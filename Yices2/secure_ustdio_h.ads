...
package secure_ustdio_h is
   ...
   --  arg-macro: procedure vsprintf (str, format, ap__builtin___vsprintf_chk (str, 0, __darwin_obsz(str), format, ap)
   --    __builtin___vsprintf_chk (str, 0, __darwin_obsz(str), format, ap)
   --  arg-macro: procedure vsnprintf (str, len, forma__builtin___vsnprintf_chk (str, len, 0, __darwin_obsz(str), format, ap)
